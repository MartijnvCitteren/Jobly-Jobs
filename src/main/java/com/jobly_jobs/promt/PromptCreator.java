...
public class PromptCreator {
    ...
    public String createPrompt(JobCreationRequestDto inputDto) {
        ...
        String sb = genericContext + createCompanyDescription(inputDto) + createTeamDescription(
    ...
    private String createBasicPrompt(JobCreationRequestDto inputDto) {
        String sb = "Act like an experienced recruiter that has great vacancy writing skills. Your task is to write " +
                ...
                inputDto.writingStyle()) + "Keep the text fairly easy to read and understand. Use short sentences " +
                "and" + " paragraphs. Aim to " + "write" + " on B2 or C1 level." + "Make sure the text is unique and " +
                "not " + "copied from other sources. " + "Also make " + "sure the text is about 1 A4 long. ";
        return sb;
    ...
    private String createCompanyDescription(JobCreationRequestDto inputDto) {
        String sb =
                "In this case write a company description and consider this " + "information as most important: " +
    ...
    private String createTeamDescription(JobCreationRequestDto inputDto) {
        String sb = "In this case write a team description and consider this " + "information as most important: the "
    ...
    private String createDateToDayDescription(JobCreationRequestDto inputDto) {
        String sb = "In this case write a day to day description and consider this " + "information as most " +
                "important: " + "the day to day activities are: :" + inputDto.tasks() + " also consider this " +
    ...
    private String createJobDescription(JobCreationRequestDto inputDto) {
        String sb =
                "In this case write a job description and consider this " + "information as most important: the " +
    ...
    private String createJobUniqueSellingPoints(JobCreationRequestDto inputDto) {
        String sb = "In this case write a job's unique selling points. There should a maximum of four USP's " + " and"
    ...
    private String createRequirements(JobCreationRequestDto inputDto) {
        String sb = "In this case write the requirements for the job and consider this " + "information as most " +
    ...
    private String createOffer(JobCreationRequestDto inputDto) {
        String sb =
                "In this case write the offer for the job and consider this " + "information as most important: " +
    ...
    private String createContactInformation(JobCreationRequestDto inputDto) {
        String sb =
                "In this case write the contact information for the job and consider this " + "information as " +
    ...
    private String createSummary(JobCreationRequestDto inputDto) {
        String sb =
                "In this case write a summary for the job and consider this " + "information as most important: " +
