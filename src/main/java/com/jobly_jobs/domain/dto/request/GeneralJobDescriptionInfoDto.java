...
public record GeneralJobDescriptionInfoDto(
        ...
        String jobTitle,
        @Size(min = 1, max = 50, message = "Function group must be between 1 and 50 characters")
        FunctionGroup functionGroup,
        @Size(min = 1, max = 100, message = "Company name must be between 1 and 100 characters")
        String companyName,
        @NotNull(message = "Min salary must be provided")
        BigDecimal minSalary,
        @NotNull(message = "Max salary must be provided")
